...
function Clock() {
    ...
    const formatter = (locales: string, options: object) => {
        return new Intl.DateTimeFormat(locales, options).format(date)
    }

    const stringTime = formatter('ru', {
        hour: "numeric",
        minute: "numeric",
        second: "numeric"
    }) || <br/> // часы24:минуты:секунды (01:02:03)/(23:02:03)/(24:00:00)/(00:00:01) // пишут студенты
    const stringDate =formatter('ru', {
            day: "numeric",
            month: "numeric",
            year: "numeric"
    ...
    const stringDay =  formatter("en-US", {weekday: "long"}) || <br/> // пишут студенты
    const stringMonth =formatter("en-US", {month: "long"}) || <br/> // пишут студенты
